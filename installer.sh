...
VERSION_DATA=$(download_file "https://github.com/Intyre/ed7ff1c2e40d79fbe37b/raw/pm-release.json")
...
if ! [ -s "$NAME.phar" ] || [ "$(head -n 1 $NAME.phar)" == '<!DOCTYPE html>' ]; then
	...
	if [ "$CHANNEL" == "soft" ]; then
		download_file "https://github.com/PocketMine/PocketMine-Soft/${BRANCH}/resources/start.sh" > start.sh
	else
		download_file "https://github.com/PocketMine/PocketMine-MP/${BRANCH}/start.sh" > start.sh
	fi
	download_file "https://github.com/PocketMine/PocketMine-MP/${BRANCH}/LICENSE" > LICENSE
	download_file "https://github.com/PocketMine/PocketMine-MP/${BRANCH}/README.md" > README.md
	download_file "https://github.com/PocketMine-MP/${BRANCH}/CONTRIBUTING.md" > CONTRIBUTING.md
	download_file "https://github.com/php-build-scripts/${BRANCH}/compile.sh" > compile.sh
fi
